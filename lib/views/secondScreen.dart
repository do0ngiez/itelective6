...
class _SecondScreenState extends State<SecondScreen> {
  List<Item> items = [
    new Item(
      ...
      price: 5005,
      imageLocation: "images/items/bag1.png"
    ),
    new Item(
      id: "2",
      ...
      price: 3503,
      imageLocation: "images/items/bag2.png"
    ),
    new Item(
      id: "3",
      ...
      price: 6507,
      imageLocation: "images/items/men1.png"
    ),
    new Item(
      id: "4",
      ...
      price: 4504,
      imageLocation: "images/items/men2.png"
    ),
    new Item(
      id: "5",
      ...
      price: 4254,
      imageLocation: "images/items/women1.png"
    ),
    new Item(
      id: "6",
      ...
      price: 4504,
      imageLocation: "images/items/women2.png"
    ),
    new Item(
      id: "7",
      ...
      price: 15266,
      imageLocation: "images/items/tent2.jpg"
    ),
    new Item(
      id: "8",
      ...
      price: 20272,
      imageLocation: "images/items/tent3.jpg"
    ),
    new Item(
      id: "9",
      ...
      price: 36790,
      imageLocation: "images/items/tent1.jpg"
    ),
    new Item(
      id: "10",
      ...
      price: 150,
      imageLocation: "images/items/a0.jpg"
    ),
    new Item(
      id: "11",
      ...
      price: 850,
      imageLocation: "images/items/a1.jpg"
    ),
    new Item(
      id: "12",
      ...
      price: 1852,
      imageLocation: "images/items/a2.jpg"
    ),
    new Item(
      id: "13",
      ...
      price: 1501,
      imageLocation: "images/items/a3.jpg"
    ),
    new Item(
      id: "14",
      ...
      price: 750,
      imageLocation: "images/items/a4.jpg"
    ),
    new Item(
      id: "15",
      ...
      price: 9510,
      imageLocation: "images/items/a5.jpg"
    ),
    new Item(
      id: "16",
      ...
      price: 5005,
      imageLocation: "images/items/a6.jpg"
    ),
    new Item(
      id: "17",
      ...
      price: 6507,
      imageLocation: "images/items/a7.jpg"
    ),
    new Item(
      id: "18",
      ...
      price: 1301,
      imageLocation: "images/items/a8.jpg"
    ),
  ];
      ...
      body: ListView(
        ...
        children: [
          CarouselSlider(
            ...
            items: [
              Image.asset('images/carousel/c0.jpeg'),
              Image.asset('images/carousel/c1.jpg'),
              Image.asset('images/carousel/c2.jpg'),
              Image.asset('images/carousel/c3.jpg'),
              Image.asset('images/carousel/c4.jpg'),
              Image.asset('images/carousel/c5.jpg'),
              Image.asset('images/carousel/c6.jpg'),
            ]
          ),
